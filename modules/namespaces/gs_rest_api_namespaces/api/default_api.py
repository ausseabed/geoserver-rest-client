...
class DefaultApi(object):
    ...
    def post_namespaces(self, body, **kwargs):  # noqa: E501
        """Add a new namespace to GeoServer  # noqa: E501

        Adds a new namespace to the server  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_namespaces(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Namespace body: The layer group body information to upload. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_namespaces_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_namespaces_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_namespaces_with_http_info(self, body, **kwargs):  # noqa: E501
        """Add a new namespace to GeoServer  # noqa: E501

        Adds a new namespace to the server  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_namespaces_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_namespaces`")  # noqa: E501
