...
class DefaultApi(object):
    ...
    def post_coverage_store_upload(self, workspace, store, method, format, **kwargs):  # noqa: E501
        ...
        :param str filename: The filename parameter specifies the target file name for a file that needs to harvested as part of a mosaic. This is important to avoid clashes and to make sure the right dimension values are available in the name for multidimensional mosaics to work. Only used if method=\"file\".
