...
class DefaultApi(object):
    ...
    def post_transform(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_transform(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Transform body: Transform body to upload. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_transform_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_transform_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_transform_with_http_info(self, body, **kwargs):  # noqa: E501
        """Add a new transform  # noqa: E501

        Adds a new transform to the server. If the content type used is application/xml the server will assume a <transform> definition is being posted, and the XSLT will have to be uploaded separately using a PUT request with content type application/xslt+xml against the transformation resource. If the content type used is application/xslt+xml the server will assume the XSLT itself is being posted, and the name, sourceFormat, outputFormat, outputMimeType query parameters will be used to fill in the transform configuration instead.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_transform_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'name', 'source_format', 'output_format', 'output_mime_type', 'file_extension']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_tranform(self, body, transform, **kwargs):  # noqa: E501
        """Modify a single transform  # noqa: E501

        Modifies a single transform.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_tranform(body, transform, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_tranform_with_http_info(body, transform, **kwargs)  # noqa: E501
        else:
            (data) = self.put_tranform_with_http_info(body, transform, **kwargs)  # noqa: E501
            return data

    def put_tranform_with_http_info(self, body, transform, **kwargs):  # noqa: E501
        """Modify a single transform  # noqa: E501

        Modifies a single transform.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_tranform_with_http_info(body, transform, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'transform']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_tranform`")  # noqa: E501
        # verify the required parameter 'transform' is set
        if ('transform' not in params or
                params['transform'] is None):
