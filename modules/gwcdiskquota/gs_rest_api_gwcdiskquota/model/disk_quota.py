...
class DiskQuota(object):
    ...
    def __init__(self, enabled=None, disk_block_size=None, cache_clean_up_frequency=None, cache_clean_up_units=None, max_concurrent_clean_ups=None, global_expiration_policy_name=None, global_quota=None, layer_quota=None):  # noqa: E501
    ...
    def cache_clean_up_units(self, cache_clean_up_units):
        ...
        if cache_clean_up_units not in allowed_values:
            raise ValueError(
    ...
    def global_expiration_policy_name(self, global_expiration_policy_name):
        ...
        if global_expiration_policy_name not in allowed_values:
            raise ValueError(
    ...
    def global_quota(self):
        ...
        When the global quota is exceeded, first any explicitly configured quota is enforced, and then the global quota is enforced acting upon all the remaining layers until the global quota is reached back.  # noqa: E501
    ...
    def layer_quota(self):
        ...
        When a layer's disk quota is reached, further tiles will be saved at the expense of other tiles which will be truncated.  # noqa: E501
