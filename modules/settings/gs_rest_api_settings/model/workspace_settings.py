...
class WorkspaceSettings(object):
    ...
    def __init__(self, contact=None, charset=None, num_decimals=None, online_resource=None, verbose=None, verbose_exceptions=None, local_workspace_includes_prefix=None):  # noqa: E501
