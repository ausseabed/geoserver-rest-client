...
class ModelGlobal(object):
    ...
    def __init__(self, settings=None, jai=None, coverage_access=None, update_sequence=None, feature_type_cache_size=None, global_services=None, xml_post_request_log_buffer_size=None):  # noqa: E501
