...
class Contact(object):
    ...
    def __init__(self, address_city=None, address_country=None, address_type=None, contact_email=None, contact_organization=None, contact_person=None, contact_position=None):  # noqa: E501
