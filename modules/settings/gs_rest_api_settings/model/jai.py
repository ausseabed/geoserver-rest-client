...
class JAI(object):
    ...
    def __init__(self, allow_interpolation=None, recycling=None, tile_priority=None, tile_threads=None, memory_capacity=None, memory_threshold=None, image_io_cache=None, png_acceleration=None, jpeg_acceleration=None, allow_native_mosaic=None, allow_native_warp=None):  # noqa: E501
