...
class Context(object):
    ...
    def __init__(self, id=None, href=None, state=None, message=None, archive=None, target_workspace=None, target_store=None, data=None, transforms=None, tasks=None):  # noqa: E501
