...
class SeedRequest(object):
    ...
    def __init__(self, name=None, bounds=None, grid_set_id=None, zoom_start=None, zoom_stop=None, type=None, thread_count=None, parameters=None):  # noqa: E501
    ...
    def bounds(self):
        ...
        A set of coordinates describing the bounds of the seed layer.  # noqa: E501
    ...
    def parameters(self):
        ...
        The filter parameters used for the requested layer  # noqa: E501
