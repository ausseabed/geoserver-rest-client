...
from gs_rest_api_styles.api_client import ApiClient
...
class DefaultApi(object):
    ...
    def post_layer_styles(self, body, layer, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_layer_styles(body, layer, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_layer_styles_with_http_info(body, layer, **kwargs)  # noqa: E501
        else:
            (data) = self.post_layer_styles_with_http_info(body, layer, **kwargs)  # noqa: E501
            return data

    def post_layer_styles_with_http_info(self, body, layer, **kwargs):  # noqa: E501
        """Add a new style  # noqa: E501

        Adds a new style entry to the layer. The style named in styleBody must already exist, and will not be altered by this request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_layer_styles_with_http_info(body, layer, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_layer_styles`")  # noqa: E501
        # verify the required parameter 'layer' is set
        if ('layer' not in params or
                params['layer'] is None):
    ...
    def post_styles(self, body, **kwargs):  # noqa: E501
        """Add a new style  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_styles(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StyleInfoPost body: 
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_styles_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_styles_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_styles_with_http_info(self, body, **kwargs):  # noqa: E501
        """Add a new style  # noqa: E501

        Adds a new style entry to the server.  Using POST with the `application/xml` or `application/json` content only adds the style info to the catalog and does not upload style content. PUT to `/styles/{style}` to upload the style in this case.  Use POST with a style file (`application/vnd.ogc.sld+xml` or `application/vnd.ogc.sld+xml` for SLD; additional style types are added by extensions) to generate a style info and upload the style all at once. Then seperately PUT the style info at `/styles/{style}` to make any desired changes to the generated catalog entry. You can also use POST with a ZIP file to upload a SLD 1.0 (`application/vnd.ogc.sld+xml`) file and any associated icon files, and then separately PUT the style info at /styles/{style}. POST with a ZIP file does not support any other style types.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_styles_with_http_info(body, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        all_params = ['body', 'content_type', 'name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_styles`")  # noqa: E501
    ...
    def post_workspace_styles(self, body, workspace, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_workspace_styles(body, workspace, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_workspace_styles_with_http_info(body, workspace, **kwargs)  # noqa: E501
        else:
            (data) = self.post_workspace_styles_with_http_info(body, workspace, **kwargs)  # noqa: E501
            return data

    def post_workspace_styles_with_http_info(self, body, workspace, **kwargs):  # noqa: E501
        """Add a new style to a given workspace  # noqa: E501

        Adds a new style entry to the server.  Using POST with the `application/xml` or `application/json` content only adds the style info to the catalog and does not upload style content. PUT to `/workspaces/{workspace}/styles/{style}` to upload the style in this case.  Use POST with a style file (`application/vnd.ogc.sld+xml` or `application/vnd.ogc.sld+xml` for SLD; additional style types are added by extensions) to generate a style info and upload the style all at once. Then seperately PUT the style info at `/workspaces/{workspace}/styles/{style}` to make any desired changes to the generated catalog entry. You can also use POST with a ZIP file to upload a SLD 1.0 (`application/vnd.ogc.sld+xml`) file and any associated icon files, and then separately PUT the style info at /workspaces/{workspace}/styles/{style}. POST with a ZIP file does not support any other style types.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_workspace_styles_with_http_info(body, workspace, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        all_params = ['body', 'workspace', 'content_type', 'name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_workspace_styles`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
    ...
    def put_style(self, body, style, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_style(body, style, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_style_with_http_info(body, style, **kwargs)  # noqa: E501
        else:
            (data) = self.put_style_with_http_info(body, style, **kwargs)  # noqa: E501
            return data

    def put_style_with_http_info(self, body, style, **kwargs):  # noqa: E501
        """Modify a single style  # noqa: E501

        Modifies a single style.  Use the \"Accept:\" header to specify format or append an extension to the endpoint (example `/styles/{style}.xml` for XML).  Using PUT with the `application/xml` or `application/json` content modifies the style info in the catalog and does not alter the style content. Using PUT with any other format will modify the content of the style. You can also use PUT with a ZIP file to upload a SLD 1.0 (`application/vnd.ogc.sld+xml`) file and any associated icon files   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_style_with_http_info(body, style, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_style`")  # noqa: E501
        # verify the required parameter 'style' is set
        if ('style' not in params or
                params['style'] is None):
    ...
    def put_workspace_style(self, body, workspace, style, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_workspace_style(body, workspace, style, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_workspace_style_with_http_info(body, workspace, style, **kwargs)  # noqa: E501
        else:
            (data) = self.put_workspace_style_with_http_info(body, workspace, style, **kwargs)  # noqa: E501
            return data

    def put_workspace_style_with_http_info(self, body, workspace, style, **kwargs):  # noqa: E501
        """Modify a single style in a given workspace  # noqa: E501

        Modifies a single style in a given workspace.  Use the \"Accept:\" header to specify format or append an extension to the endpoint (example `/workspaces/{workspace}/styles/{style}.xml` for XML).  Using PUT with the `application/xml` or `application/json` content modifies the style info in the catalog and does not alter the style content. Using PUT with any other format will modify the content of the style. You can also use PUT with a ZIP file to upload a SLD 1.0 (`application/vnd.ogc.sld+xml`) file and any associated icon files   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_workspace_style_with_http_info(body, workspace, style, async_req=True)
        >>> result = thread.get()
...
Otherwise, the style body is an actual style:
 ...
 (required)
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_workspace_style`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
