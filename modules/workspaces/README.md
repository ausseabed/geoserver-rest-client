...
```sh
pip install git+https://github.com/ausseabed/geoserver-rest-client#egg=version_subpkg\&subdirectory=modules/workspaces.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/ausseabed/geoserver-rest-client#egg=version_subpkg\&subdirectory=modules/workspaces.git`)
