...
class DefaultApi(object):
    ...
    def post_workspaces(self, body, **kwargs):  # noqa: E501
        """add a new workspace to GeoServer  # noqa: E501

        Adds a new workspace to the server  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_workspaces(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Workspace body: The layer group body information to upload. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_workspaces_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_workspaces_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_workspaces_with_http_info(self, body, **kwargs):  # noqa: E501
        """add a new workspace to GeoServer  # noqa: E501

        Adds a new workspace to the server  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_workspaces_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_workspaces`")  # noqa: E501
    ...
    def put_workspace(self, body, workspace_name, **kwargs):  # noqa: E501
        """Update a workspace  # noqa: E501

        takes the body of the post and modifies the workspace from it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_workspace(body, workspace_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_workspace_with_http_info(body, workspace_name, **kwargs)  # noqa: E501
        else:
            (data) = self.put_workspace_with_http_info(body, workspace_name, **kwargs)  # noqa: E501
            return data

    def put_workspace_with_http_info(self, body, workspace_name, **kwargs):  # noqa: E501
        """Update a workspace  # noqa: E501

        takes the body of the post and modifies the workspace from it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_workspace_with_http_info(body, workspace_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_workspace`")  # noqa: E501
        # verify the required parameter 'workspace_name' is set
        if ('workspace_name' not in params or
                params['workspace_name'] is None):
