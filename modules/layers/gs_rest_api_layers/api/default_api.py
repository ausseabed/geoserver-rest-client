...
class DefaultApi(object):
    ...
    def layers_name_put(self, body, layer_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.layers_name_put(body, layer_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.layers_name_put_with_http_info(body, layer_name, **kwargs)  # noqa: E501
        else:
            (data) = self.layers_name_put_with_http_info(body, layer_name, **kwargs)  # noqa: E501
            return data

    def layers_name_put_with_http_info(self, body, layer_name, **kwargs):  # noqa: E501
        """Modify a layer.  # noqa: E501

        Modifies an existing layer on the server. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"/layers/{layer}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.layers_name_put_with_http_info(body, layer_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'layer_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `layers_name_put`")  # noqa: E501
        # verify the required parameter 'layer_name' is set
        if ('layer_name' not in params or
                params['layer_name'] is None):
    ...
    def layers_name_workspace_put(self, body, workspace_name, layer_name, **kwargs):  # noqa: E501
        """Modify a layer.  # noqa: E501

        Modifies an existing layer on the server. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"/layers/{layer}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.layers_name_workspace_put(body, workspace_name, layer_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.layers_name_workspace_put_with_http_info(body, workspace_name, layer_name, **kwargs)  # noqa: E501
        else:
            (data) = self.layers_name_workspace_put_with_http_info(body, workspace_name, layer_name, **kwargs)  # noqa: E501
            return data

    def layers_name_workspace_put_with_http_info(self, body, workspace_name, layer_name, **kwargs):  # noqa: E501
        """Modify a layer.  # noqa: E501

        Modifies an existing layer on the server. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"/layers/{layer}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.layers_name_workspace_put_with_http_info(body, workspace_name, layer_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `layers_name_workspace_put`")  # noqa: E501
        # verify the required parameter 'workspace_name' is set
        if ('workspace_name' not in params or
                params['workspace_name'] is None):
