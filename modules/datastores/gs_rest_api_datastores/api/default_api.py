...
from gs_rest_api_datastores.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class DefaultApi(object):
    ...
    def clean_all_mongo_schemas_with_http_info(self, workspace_name, store_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `clean_all_mongo_schemas`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `clean_all_mongo_schemas`")  # noqa: E501
        ...
        if 'store_name' in local_var_params:
            path_params['storeName'] = local_var_params['store_name']  # noqa: E501
    ...
    def clean_mongo_schema_with_http_info(self, workspace_name, store_name, internal_store_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `clean_mongo_schema`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `clean_mongo_schema`")  # noqa: E501
        # verify the required parameter 'internal_store_id' is set
        if self.api_client.client_side_validation and ('internal_store_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['internal_store_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `internal_store_id` when calling `clean_mongo_schema`")  # noqa: E501
        ...
        if 'store_name' in local_var_params:
            path_params['storeName'] = local_var_params['store_name']  # noqa: E501
        if 'internal_store_id' in local_var_params:
            path_params['internalStoreId'] = local_var_params['internal_store_id']  # noqa: E501
    ...
    def delete_datastore_with_http_info(self, workspace_name, store_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `delete_datastore`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `delete_datastore`")  # noqa: E501
        ...
        query_params = []
        if 'recurse' in local_var_params and local_var_params['recurse'] is not None:  # noqa: E501
            query_params.append(('recurse', local_var_params['recurse']))  # noqa: E501
    ...
    def get_data_store_with_http_info(self, workspace_name, store_name, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Datastore, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `get_data_store`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `get_data_store`")  # noqa: E501
        ...
        query_params = []
        if 'quiet_on_not_found' in local_var_params and local_var_params['quiet_on_not_found'] is not None:  # noqa: E501
            query_params.append(('quietOnNotFound', local_var_params['quiet_on_not_found']))  # noqa: E501
    ...
    def get_data_store_upload_with_http_info(self, workspace_name, store_name, method, format, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `get_data_store_upload`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `get_data_store_upload`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('method' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `method` when calling `get_data_store_upload`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('format' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `format` when calling `get_data_store_upload`")  # noqa: E501
        ...
        if 'method' in local_var_params:
            path_params['method'] = local_var_params['method']  # noqa: E501
    ...
    def get_datastores_with_http_info(self, workspace_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `get_datastores`")  # noqa: E501
    ...
    def post_datastores_with_http_info(self, workspace_name, data_store_body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `post_datastores`")  # noqa: E501
        # verify the required parameter 'data_store_body' is set
        if self.api_client.client_side_validation and ('data_store_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['data_store_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `data_store_body` when calling `post_datastores`")  # noqa: E501
        ...
        body_params = None
        if 'data_store_body' in local_var_params:
            body_params = local_var_params['data_store_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/xml', 'application/json', 'text/html'])  # noqa: E501
    ...
    def put_data_store_upload(self, workspace_name, store_name, method, format, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str workspace_name: The name of the worskpace containing the coverage stores. (required)
        :param str store_name: The name of the store to be retrieved (required)
    ...
    def put_data_store_upload_with_http_info(self, workspace_name, store_name, method, format, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `put_data_store_upload`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `put_data_store_upload`")  # noqa: E501
        # verify the required parameter 'method' is set
        if self.api_client.client_side_validation and ('method' not in local_var_params or  # noqa: E501
                                                        local_var_params['method'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `method` when calling `put_data_store_upload`")  # noqa: E501
        # verify the required parameter 'format' is set
        if self.api_client.client_side_validation and ('format' not in local_var_params or  # noqa: E501
                                                        local_var_params['format'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `format` when calling `put_data_store_upload`")  # noqa: E501
        ...
        query_params = []
        if 'configure' in local_var_params and local_var_params['configure'] is not None:  # noqa: E501
            query_params.append(('configure', local_var_params['configure']))  # noqa: E501
        ...
        if 'update' in local_var_params and local_var_params['update'] is not None:  # noqa: E501
            query_params.append(('update', local_var_params['update']))  # noqa: E501
        if 'charset' in local_var_params and local_var_params['charset'] is not None:  # noqa: E501
            query_params.append(('charset', local_var_params['charset']))  # noqa: E501
    ...
    def put_datastore_with_http_info(self, workspace_name, store_name, data_store_body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `put_datastore`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `put_datastore`")  # noqa: E501
        # verify the required parameter 'data_store_body' is set
        if self.api_client.client_side_validation and ('data_store_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['data_store_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `data_store_body` when calling `put_datastore`")  # noqa: E501
    ...
    def rebuild_all_mongo_schemas_with_http_info(self, workspace_name, store_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `rebuild_all_mongo_schemas`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `rebuild_all_mongo_schemas`")  # noqa: E501
    ...
    def rebuild_mongo_schema_with_http_info(self, workspace_name, store_name, internal_store_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('workspace_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['workspace_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `workspace_name` when calling `rebuild_mongo_schema`")  # noqa: E501
        # verify the required parameter 'store_name' is set
        if self.api_client.client_side_validation and ('store_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['store_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `store_name` when calling `rebuild_mongo_schema`")  # noqa: E501
        # verify the required parameter 'internal_store_id' is set
        if self.api_client.client_side_validation and ('internal_store_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['internal_store_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `internal_store_id` when calling `rebuild_mongo_schema`")  # noqa: E501
