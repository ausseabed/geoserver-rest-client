...
class DefaultApi(object):
    ...
    def clean_mongo_schema_with_http_info(self, workspace_name, store_name, internal_store_id, **kwargs):  # noqa: E501
        ...
        if ('internal_store_id' not in params or
                params['internal_store_id'] is None):
    ...
    def post_datastores(self, body, workspace_name, **kwargs):  # noqa: E501
        """Create a new data store  # noqa: E501

        Adds a new data store to the workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_datastores(body, workspace_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Datastore body: The data store body information to upload.
...
- Web Feature Service
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_datastores_with_http_info(body, workspace_name, **kwargs)  # noqa: E501
        else:
            (data) = self.post_datastores_with_http_info(body, workspace_name, **kwargs)  # noqa: E501
            return data

    def post_datastores_with_http_info(self, body, workspace_name, **kwargs):  # noqa: E501
        """Create a new data store  # noqa: E501

        Adds a new data store to the workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_datastores_with_http_info(body, workspace_name, async_req=True)
        >>> result = thread.get()
...
- Web Feature Service
 ...
 (required)
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_datastores`")  # noqa: E501
        # verify the required parameter 'workspace_name' is set
        if ('workspace_name' not in params or
                params['workspace_name'] is None):
    ...
    def put_datastore(self, body, workspace_name, store_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_datastore(body, workspace_name, store_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Datastore body: The updated data store definition.
...
- Web Feature Service
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_datastore_with_http_info(body, workspace_name, store_name, **kwargs)  # noqa: E501
        else:
            (data) = self.put_datastore_with_http_info(body, workspace_name, store_name, **kwargs)  # noqa: E501
            return data

    def put_datastore_with_http_info(self, body, workspace_name, store_name, **kwargs):  # noqa: E501
        """Modify a data store.  # noqa: E501

        Modify data store ds. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"/datastores/{ds}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_datastore_with_http_info(body, workspace_name, store_name, async_req=True)
        >>> result = thread.get()
...
- Web Feature Service
 ...
 (required)
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_datastore`")  # noqa: E501
        # verify the required parameter 'workspace_name' is set
        if ('workspace_name' not in params or
                params['workspace_name'] is None):
