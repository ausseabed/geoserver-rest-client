...
class Datastore(object):
    ...
    def __init__(self, name=None, description=None, enabled=None, workspace=None, connection_parameters=None, default=None, feature_types=None, local_vars_configuration=None):  # noqa: E501
        """Datastore - a model defined in OpenAPI"""  # noqa: E501
