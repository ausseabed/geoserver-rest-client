...
import gs_rest_api_datastores.model
from gs_rest_api_datastores import rest
from gs_rest_api_datastores.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gs_rest_api_datastores.model, klass)
