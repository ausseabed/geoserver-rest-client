...
class DefaultApi(object):
    ...
    def layers_name_post(self, body, layer_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.layers_name_post(body, layer_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.layers_name_post_with_http_info(body, layer_name, **kwargs)  # noqa: E501
        else:
            (data) = self.layers_name_post_with_http_info(body, layer_name, **kwargs)  # noqa: E501
            return data

    def layers_name_post_with_http_info(self, body, layer_name, **kwargs):  # noqa: E501
        """Modify a cached layer (Deprecated).  # noqa: E501

        Modifies an existing cached layer on the server. Deprecated - use PUT instead.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.layers_name_post_with_http_info(body, layer_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `layers_name_post`")  # noqa: E501
        # verify the required parameter 'layer_name' is set
        if ('layer_name' not in params or
                params['layer_name'] is None):
    ...
    def layers_name_put(self, body, layer_name, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Layer body: The new layer definition. (required)
