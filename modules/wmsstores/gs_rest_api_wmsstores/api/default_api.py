...
class DefaultApi(object):
    ...
    def post_wms_stores(self, body, workspace, **kwargs):  # noqa: E501
        """Add a new WMS store  # noqa: E501

        Adds a new WMS store entry to the server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_wms_stores(body, workspace, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param WMSStoreInfo body: WMS store body information to upload.
...
- application/json:
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_wms_stores_with_http_info(body, workspace, **kwargs)  # noqa: E501
        else:
            (data) = self.post_wms_stores_with_http_info(body, workspace, **kwargs)  # noqa: E501
            return data

    def post_wms_stores_with_http_info(self, body, workspace, **kwargs):  # noqa: E501
        """Add a new WMS store  # noqa: E501

        Adds a new WMS store entry to the server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_wms_stores_with_http_info(body, workspace, async_req=True)
        >>> result = thread.get()
...
- application/json:
 ...
 (required)
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_wms_stores`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
    ...
    def put_wms_store(self, body, workspace, store, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_wms_store(body, workspace, store, async_req=True)
        >>> result = thread.get()
...
- application/json:
 ...
 (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_wms_store_with_http_info(body, workspace, store, **kwargs)  # noqa: E501
        else:
            (data) = self.put_wms_store_with_http_info(body, workspace, store, **kwargs)  # noqa: E501
            return data

    def put_wms_store_with_http_info(self, body, workspace, store, **kwargs):  # noqa: E501
        """Modify a single WMS store.  # noqa: E501

        Modifies a single WMS store. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"{store}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_wms_store_with_http_info(body, workspace, store, async_req=True)
        >>> result = thread.get()
...
- application/json:
 ...
 (required)
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_wms_store`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
