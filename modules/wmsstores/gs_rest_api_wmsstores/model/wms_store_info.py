...
class WMSStoreInfo(object):
    ...
    def __init__(self, name=None, description=None, type=None, enabled=None, workspace=None, metadata=None, default__=None, capabilities_url=None, user=None, password=None, max_connections=None, read_timeout=None, connect_timeout=None, wms_layers=None):  # noqa: E501
    ...
    def metadata(self):
        ...
        Miscellaneous configuration details about the WMS store  # noqa: E501
