...
class DefaultApi(object):
    ...
    def delete_layergroup_with_http_info(self, layergroup_name, **kwargs):  # noqa: E501
        ...
        if ('layergroup_name' not in params or
                params['layergroup_name'] is None):
    ...
    def delete_workspace_layergroup_with_http_info(self, layergroup, workspace, **kwargs):  # noqa: E501
        ...
        if ('layergroup' not in params or
                params['layergroup'] is None):
    ...
    def post_layergroups(self, body, **kwargs):  # noqa: E501
        """Add a new layer group  # noqa: E501

        Adds a new layer group entry to the server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_layergroups(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Layergroup body: The layer group body information to upload. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_layergroups_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_layergroups_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_layergroups_with_http_info(self, body, **kwargs):  # noqa: E501
        """Add a new layer group  # noqa: E501

        Adds a new layer group entry to the server.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_layergroups_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_layergroups`")  # noqa: E501
    ...
    def put_layergroup(self, body, layergroup_name, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_layergroup(body, layergroup_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Layergroup body: The updated layer group definition. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_layergroup_with_http_info(body, layergroup_name, **kwargs)  # noqa: E501
        else:
            (data) = self.put_layergroup_with_http_info(body, layergroup_name, **kwargs)  # noqa: E501
            return data

    def put_layergroup_with_http_info(self, body, layergroup_name, **kwargs):  # noqa: E501
        """Modify a layer group.  # noqa: E501

        Modifies an existing layer group on the server. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"/layergroups/{layergroup}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_layergroup_with_http_info(body, layergroup_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'layergroup_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_layergroup`")  # noqa: E501
        # verify the required parameter 'layergroup_name' is set
        if ('layergroup_name' not in params or
                params['layergroup_name'] is None):
    ...
    def put_workspace_layergroup(self, body, workspace, layergroup, **kwargs):  # noqa: E501
        """Modify a layer group.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_workspace_layergroup(body, workspace, layergroup, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_workspace_layergroup_with_http_info(body, workspace, layergroup, **kwargs)  # noqa: E501
        else:
            (data) = self.put_workspace_layergroup_with_http_info(body, workspace, layergroup, **kwargs)  # noqa: E501
            return data

    def put_workspace_layergroup_with_http_info(self, body, workspace, layergroup, **kwargs):  # noqa: E501
        """Modify a layer group.  # noqa: E501

        Modifies an existing layer group on the server in the given workspace. Use the \"Accept:\" header to specify format or append an extension to the endpoint (example \"/workspaces/{workspace}/layergroups/{layergroup}.xml\" for XML).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_workspace_layergroup_with_http_info(body, workspace, layergroup, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'workspace', 'layergroup']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_workspace_layergroup`")  # noqa: E501
        # verify the required parameter 'workspace' is set
        if ('workspace' not in params or
                params['workspace'] is None):
