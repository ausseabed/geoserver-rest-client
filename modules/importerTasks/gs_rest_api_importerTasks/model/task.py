...
class Task(object):
    ...
    def __init__(self, id=None, href=None, state=None, update_mode=None, data=None, target=None, progress=None, layer=None, error_message=None, transform_chain=None, messages=None):  # noqa: E501
    ...
    def update_mode(self, update_mode):
        ...
        if update_mode not in allowed_values:
            raise ValueError(
