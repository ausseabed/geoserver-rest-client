...
from gs_rest_api_importerTransforms.api_client import ApiClient
...
class DefaultApi(object):
    ...
    def delete_transform_with_http_info(self, import_id, task_id, transform_id, **kwargs):  # noqa: E501
        ...
        if ('transform_id' not in params or
                params['transform_id'] is None):
    ...
    def post_transform(self, body, import_id, task_id, **kwargs):  # noqa: E501
        """Create a new transformation  # noqa: E501

        Create a new transormation and append it inside a task with id {taskId} within import with id {importId}  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_transform(body, import_id, task_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Transform body: The transform to add. (required)
        :param str import_id: The ID of the import (required)
        :param str task_id: The ID of the task (required)
        :param str expand: What level to expand the response object to. Can be \"self\" (expand only the response object and its immediate children), \"all\" (expand all children), \"none\" (don't include any children), or a nonnegative integer, indicating the depth of children to expand to. Defaults to \"self\" or \"none\", depending on the request.
        :return: None
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_transform_with_http_info(body, import_id, task_id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_transform_with_http_info(body, import_id, task_id, **kwargs)  # noqa: E501
            return data

    def post_transform_with_http_info(self, body, import_id, task_id, **kwargs):  # noqa: E501
        """Create a new transformation  # noqa: E501

        Create a new transormation and append it inside a task with id {taskId} within import with id {importId}  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_transform_with_http_info(body, import_id, task_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_transform`")  # noqa: E501
        # verify the required parameter 'import_id' is set
        if ('import_id' not in params or
                params['import_id'] is None):
    ...
    def put_transform(self, body, import_id, task_id, transform_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_transform(body, import_id, task_id, transform_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_transform_with_http_info(body, import_id, task_id, transform_id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_transform_with_http_info(body, import_id, task_id, transform_id, **kwargs)  # noqa: E501
            return data

    def put_transform_with_http_info(self, body, import_id, task_id, transform_id, **kwargs):  # noqa: E501
        """Modifies a transformation  # noqa: E501

        Modifies the definition of a transformation identified by {transformId} inside a task with id {taskId} within import with id {importId}  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_transform_with_http_info(body, import_id, task_id, transform_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'import_id', 'task_id', 'transform_id', 'expand']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_transform`")  # noqa: E501
        # verify the required parameter 'import_id' is set
        if ('import_id' not in params or
                params['import_id'] is None):
